...
const AUTOMOTIVE_ACTORS = [
  'compass/crawler-google-places',              // Main Google Maps scraper
  'compass/google-maps-extractor',              // Faster alternative
  'lukaskrivka/google-maps-with-contact-details', // Contact enrichment
